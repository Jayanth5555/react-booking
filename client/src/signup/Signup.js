    ...
    <div className="primeCont">
      <div className="contentArea">
        <div className="right">
          ...
          <form>
            ...
            <input
              ...
              type="text"placeholder="Phone" id="phone"onChange={handleChange}
              required
            />
            ...
            <input
              ...
              type="text"placeholder="City"id="city"onChange={handleChange}
              required
            />
        ...
        {/* <img className="logol" src={logos} alt="" /> */}
          <h1 className="hotelbooking">welcome Hotel Booking</h1>
